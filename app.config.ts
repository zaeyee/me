...
export default defineAppConfig({
  ...
  socials: [
    { icon: 'i-ri:heart-2-line', link: 'https://antfu.me/sponsors-list' },
    { icon: 'i-ri:twitter-x-line', link: 'https://twitter.com/antfu7' },
    { icon: 'i-uil:github-alt', link: 'https://github.com/antfu' }
  ],
  projects: {
    Upcoming: [
      {
